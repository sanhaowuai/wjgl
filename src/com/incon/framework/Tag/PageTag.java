	...
	public int doStartTag() throws JspException {
		...
		if (pageCount > 1 || "true".equals(this.onlyOneShow)
			...
			try {
				...
				//out.print("	if(size > 500) {size = 500;}\n");
...
//						+ "页</span></li>\n");
				...
				out.print("<li><span class=\""+msgStyle+"\"  >转到</span></li><li><span  ><input  class=\""+msgStyle+"\"   style=\" color:#35418c;width:20px;height:14px;border-width:0px 0px 1px 0px ;border-style:solid; border-color:#35418c;text-align:center; font-weight:bold \" id=\"pn\"  max="+pageCount+"  \" onkeyup=\"this.value=this.value.replace(/\\D/g,'')\"  onafterpaste=\"this.value=this.value.replace(/\\D/g,'')\" maxlength=\"5\" size=\"14\" name=\"pn\" type=\"text\"   value=\""+pageNo+"\"  /> </span></li><li ><span class=\""+msgStyle+"\"  >页</span> </li><li  class=\""+otherStyle+"\" > <a  href=\"javascript:void(0)\"  onclick=\"jump(document.getElementById('pn').value)\"  ><b>GO</b></a></li>");
				//out.print("</ul>");
 				if ("true".equals(this.showReSize)
						|| "TRUE".equals(this.showReSize)) {
					out.print("<li><span class=\""+msgStyle+"\"  >每页</span></li><li><span   ><input class=\""+msgStyle+"\"   style=\" color:#35418c;width:20px;height:14px;border-width:0px 0px 1px 0px ;border-style:solid; border-color:#35418c;text-align:center; font-weight:bold \" title=\"输入数字,回车设置每页显示条数!\" type=\"text\" id=\"pageSize_value\" "
