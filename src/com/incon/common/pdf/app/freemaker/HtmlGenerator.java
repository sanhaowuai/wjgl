package com.incon.common.pdf.app.freemaker;
...
public class HtmlGenerator {     
    ...
    public String generate(String template, Map<String,Object> variables) throws IOException, TemplateException{     
         ...
         * @throws Exception   
         */    
        public String generate(String template,List<Map<String,Object>>  variableslist, Map<String,Object> variables) throws IOException, TemplateException{     
            BufferedWriter writer = null;   
            String htmlContent = "";
            try{
            	Configuration config = FreemarkerConfiguration.getConfiguation();     
