       ...
       <c:if test="${lbgn.djsj eq 'onModel'}">
            ...
            <c:forEach items="${ymgns}" var="ymgn">
              <c:if test="${ymgn.djsj eq 'onAdd'}">
                <button id="button_${ymgn.id}" type="button" class="btn btn-info" onclick="onAdd('${ymgn.djsjdz}','${ymgn.anmc}','${ymgn.id}');">${ymgn.anmc}</button>
              </c:if>
              <c:if test="${ymgn.djsj eq 'onBatchDel'}">
                <button id="button_${ymgn.id}" type="button" class="btn btn-info" onclick="onBatchDel('${ymgn.id}');">${ymgn.anmc}</button>
              </c:if>
              <c:if test="${ymgn.djsj eq 'onBatchUpd'}">
                <button id="button_${ymgn.id}" type="button" class="btn btn-info" onclick="onBatchUpd('${ymgn.id}');">${ymgn.anmc}</button>
              </c:if>
              <c:if test="${ymgn.djsj eq 'onBatchExpdata'}">
                <button id="button_${ymgn.id}" type="button" class="btn btn-info" onclick="onBatchExpdata();">${ymgn.anmc}</button>
              </c:if>
              <c:if test="${ymgn.djsj eq 'onBatchAdd'}">
                <button id="button_${ymgn.id}" type="button" class="btn btn-info" onclick="onBatchAdd();">${ymgn.anmc}</button>
              </c:if>
