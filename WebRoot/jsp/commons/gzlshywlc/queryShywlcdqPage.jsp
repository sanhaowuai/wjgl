...
<style type="text/css">
  ...
  *html .Contentbox { height:100% }
  ...
  <script type="text/javascript" >
	...
	//签收
	function qs(dqjddm,ywlcdm,ywlcslid){
		var url="<%=path%>/gzlshywlc/updShywlcQs";
		var param={'dqjddm':dqjddm,'ywlcdm':ywlcdm,'ywlcslid':ywlcslid};
...
<div class="Contentbox">
  <div class="pd10">    
	 ...
	 <div class="dropdown pull-right">
	   ...
	   <div class="btn-group">
          ...
          <table border="0" width="96%"  cellpadding="0" cellspacing="0"  >
		      <tr>
		      	<th width="120">标题：</th>
	           	<td> <input type="text" name="pageBt" id="pageBt" value="${gzlShywlcdqPage.pageBt}"  /></td>
		       </tr>
		       <tr>
		        <th>业务名称：</th>
	           	<td><input type="text" name="pageYwlcgjz" id="pageYwlcgjz" value="${gzlShywlcdqPage.pageYwlcgjz}"  /></td>
		      </tr>
		      <tr>
	           	...
	           	<td>
	           	  <select name="pageYwlclbdm" id="pageYwlclbdm"  >
	      		    ...
	      		    <c:forEach items="${ywlclbList}" var="map" varStatus="status">
	       		      <option value='${map.DM}' <c:if test="${map.DM eq gzlShywlcdqPage.pageYwlclbdm}">selected</c:if>>
	    		         ${map.MC}
	    	          </option>
				    </c:forEach>
	    		  </select>
        ...
        <table  class="table table-bordered bot_line">
         ...
         <c:forEach items="${list}" var="a">
         	<tr>
	            ...
	            <td>${a.yshjdztxsmc }</td>
	            <td>
	            <div  onclick="javascript:qs('${a.dqjddm}','${a.ywlcdm}','${a.ywlcslid}');" class="cz_button cz_bg1"><span class="glyphicon glyphicon-pencil"></span></div>
    ...
    <div class="youtube"> 
        <c:if test="${not empty gzlShywlcdqPage }">
            <ff:page mhFrom="queryform" showReSize="true" listPageCount="10" field="gzlShywlcdqPage" onlyOneShow="true" showListNo="true" action="gzlshywlc/queryShywlcdqPage"/>
        </c:if>
    </div>
    <div class="clr"></div>
  </div>
