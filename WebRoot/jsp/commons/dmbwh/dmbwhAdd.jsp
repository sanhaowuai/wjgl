        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" style="text-align: center; float:none" class="addlist">
			...
			<tr>
				...
				<td style="text-align:left;"  width="380px">
					<input type="text" name="tablename" id='tablename' value="" style="color: black;" maxlength="100" dataType="Require" msg="必填"/>
					<span class="red">*</span>
				</td>
			</tr>
			<tr>
				...
				<td style="text-align:left;"  width="380px">
					<input type="text" name="dm" id='dm' value="" style="color: black;" maxlength="100" dataType="Require" msg="必填"/>
					<span class="red">*</span>
				</td>
			</tr>
			<tr>
				...
				<td style="text-align:left;"  width="380px">
					<input type="text" name="mc" id='mc' value="" style="color: black;" maxlength="100" dataType="Require" msg="必填"/>
					<span class="red">*</span>
				</td>
			</tr>
        </table>
