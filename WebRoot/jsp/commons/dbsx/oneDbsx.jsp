...
<div class="Contentbox">
 ...
 <div class="pd10"> 
   <div class="address"  id="ycid"><span class="Floatleft">当前位置：待办事项</span> </div>
   <div class="clr"></div>
    <div class="butsea">
  ...
  <div class="clr"></div>
   ...
   <input type="hidden" name="sfyd"  id="sfyd_id" value="${dbsxPage.sfyd}"  />
      ...
      <div class="newsinfor">
         <span class="pl10">是否完成:<c:if test="${entity.sfwc eq '1'}">是</c:if>
   			  <c:if test="${entity.sfwc ne '1'}">否</c:if></span>
          <span class="pl10">完成时间:${entity.wcsj}</span>
      </div>
      <div class="newsnr">
       ${entity.nr}
      </div>
