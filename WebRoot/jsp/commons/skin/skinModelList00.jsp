...
$(function() {
    ...
    $("#button-bgs").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg5.jpg");
    ...
    $("#button-bgs2").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg2.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs3").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs5").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/giftly.png");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs6").click(function() {
    	...
    	$(window.parent.document).find("body").css({
    		"background": "url('"+path+"/resources/style/blue/images/bg.jpg')repeat",
            "background-size":"cover"
        });
    ...
    $("#button-bgs7").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg3.png");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs8").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg8.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs9").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg9.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs10").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg10.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs11").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg11.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs12").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg12.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
    ...
    $("#button-bgs13").click(function() {
    	$("#pfbj").val("/resources/style/blue/images/bg13.jpg");
		document.queryform.action = '<%=path%>/skin/choose00';
		$('#queryform').ajaxSubmit(function(r){
		});
    	$(window.parent.document).find("body").css({
