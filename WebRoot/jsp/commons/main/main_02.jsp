        ...
        <div id="tabs_container"> 
              <ul id="nav">
		         <c:forEach items="${orderListFather}" var="fmap" varStatus="i">
					<li><a href="<%=path%>/getOrder2?qxdm=${fmap.QXDM}" target="iframename0"><span>${fmap.QXMC}</span></a></li>
					<li class="line"></li>
				</c:forEach>      
              </ul> 
        </div>
...
<div id="tabs_portal_0_panel">
	<div class="main_left" name="fmTitle" id="frmTitle">
		<iframe id="iframename0" name="iframename0" src="<%=path%>/getOrder2?qxdm=01" border="0" framespacing="0" marginheight="0" marginwidth="0" style="width: 210px; height: 100%;" frameborder="0" allowTransparency="true"></iframe>
	</div>
