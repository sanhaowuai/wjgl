...
<script src="<%=path%>/resources/style/blueTwo/js/bottomMenuTwo.js"></script>
<script src="<%=path%>/resources/style/blueTwo/js/index_13.js?asa=127" type="text/javascript"></script> 
...
function colRwLoc(){
	...
	$("#tabs_container div a.tab").live("click",function (){
		var y=$(this).attr("index");
		window.parent.iframename0.eachFun(y);
		});
	$("#tabs_container div a.close").live("click",function (){
		var na=$(this).parent("div");
		
			setTimeout(function (){
				$("#tabs_container div").each(function(){
					if($(this).hasClass("selected")){
						var r=$(this).find("a").attr("index");
						window.parent.iframename0.eachFun(r);
						};
					});
				},350);
...
<body style="height:100%;overflow-y:hidden; zoom:1;background:#374b63" onload="init();">
			...
			<c:choose>
	          ...
	          <div class="toptip"  id="tooltitle_a" style="display:none">
	              ...
	              <div class="top-inner">${map.ms} </div>
		   		...
		   		<a class="pngFix"  href="javascript:void(0);" onclick="javascript:closeAllTab();" onmouseover="toShow('th');" onmouseout="toHidden('th')"  id="th">
		 		<i class="${map.icon}"></i><span>${map.ms}</span></a> 
...
<div class="clr"></div>
<!-- iframe -->
<div id="tabs_portal_0_panel" style="position:relative;">
	<div class="main_left" style="position:absolute;left:0;top:0;z-index:100;width:100%;height:100%;" name="fmTitle" id="frmTitle">
		<div id="skin-select" style="width:100%;">
			<div class="skin-dinwei" id="skin-dinwei"><i class="fa fa-caret-left"></i></div>
			<ul id="menus" style="display:none;" class="topnav menu-left-nest">
				<li>
    ...
    <div id="myiframes">
	    ...
	    <div  id="center" class="container-fluid paper-wrap bevel tlbr">
			<div id="tabs_portal_0_panel"  class="tabs-panel selected">
		    	<iframe id="tabs_portal_0_iframe"  name="tabs_portal_0_iframe" src="<%=path%>/getOrder"  border="0" framespacing="0" marginheight="0" marginwidth="0" frameborder="0" allowTransparency="true"></iframe>
		    </div>  
		</div>
	</div>
    <div id="cdbutton"></div>
