...
<script src="<%=path%>/resources/style/blueSeven/js/bottomMenuTwo.js"></script>
<script src="<%=path%>/resources/style/blueSeven/js/index_13.js?asa=127" type="text/javascript"></script> 
...
$(function(){
	...
	$('#taskbar_center').width(widths);
	$('#tabs_container').width(widths);
	$(window).resize(function (){
		widths = $(window).width();
		if(isHidden == 0){
			$('#taskbar_center').width(widths);
	...
	$('#toggle').click(function(){
		if(isHidden == 0){//缩小
			isHidden = 1;
			$('ul.topnav').animate({"left":"70px"},100);
			//收放按变化
			$('#skin-select #toggle').addClass("entypo-menu");
			$('#skin-select #toggle').removeClass("fa fa-remove");
			$('#frmTitle').animate({"width":"50px","padding-left":"0","left":"-70px"},200);

			
			$('.title-menu-left').find('span').hide();
			$('.title-menu-left').find('i').css({"left":"0px"});
			...
			isHidden = 0;
			$('ul.topnav').animate({"left":"0px"},100);
			//收放按变化
			$('#skin-select #toggle').removeClass("entypo-menu");
			$('#skin-select #toggle').addClass("fa fa-remove");
			$('#frmTitle').animate({"width":"100%","padding-left":"0","left":"0px"},200);

			
<%--			$('.title-menu-left').find('span').show();--%>
			$('.title-menu-left').find('i').css({"left":"5px"});
...
<div class="clr"></div>
<!-- iframe -->
<div id="tabs_portal_0_panel" style="postion:relative;">
			...
			<ul id="menus"  class="topnav menu-left-nest">
				<li>
	                 <a href="javascript:;" style="border-left:0px solid!important;" class="title-menu-left">
	                     <span style="display:none">栏目导航</span>
