...
$(document).ready(function() {initMenu();});
	...
	function iconCol(colorNas){//左侧icon一级
		...
		$("head").children("style").append('ul#menus>li>a:hover{color:'+colorNas+'!important} ul#menus>li>a i{color:'+colorNas+'} ul#menus>li>a:hover{border-left-color: '+colorNas+';} ul#menus>li>a:hover:after{border-bottom-color:'+colorNas+';}')
	}
...
<%--        	$(window.parent.document).find("#taskbar_right").css("background-color",colors.str4[1]);/*顶部右侧导航颜色*/--%>
 ...
 <%--新增更改的颜色值-star---%>
        ...
        leftIconColB:function (){
        	...
        	window.parent.iframename0.iconColB(colorss.str2);
        },
        leftIconColC:function (){
            
        	window.parent.iframename0.iconColC(colorss.str2);
        },
        leftTextColA:function (){
            
        	window.parent.iframename0.textColA(colorss.str2);
        },
        leftTextColB:function (){
               
        	window.parent.iframename0.textColB(colorss.str2);
        },
        leftTextColC:function (){
            
        	window.parent.iframename0.textColC(colorss.str2);
        },
		leftColorHovB:function (){
        	
    		window.parent.iframename0.txsB(colorss.str2);
        },
		leftColorHovC:function (){
        	
    		window.parent.iframename0.txsC(colorss.str2);
        },
