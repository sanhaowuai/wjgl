...
<script src="<%=path%>/resources/js/bottomMenuTwo.js"></script>
<script src="<%=path%>/resources/js/common/task/index_13.js?asa=127" type="text/javascript"></script> 
...
<%--<script type="text/javascript" src="<%=path%>/resources/style/blue/js/huanfu.js"></script>--%>
...
$(function(){	
	...
	$(".huanfu_con").mouseover(function(){
		$(this).find(".huanfu_warp").show()	
	})
	$(".huanfu_con").mouseout(function(){
		$(this).find(".huanfu_warp").hide()	
	})		
})
<%--    加載完成時用戶保存的背景--%>
$(function (){
...
<body style="height:100%;overflow-y:hidden; zoom:1;background:url(<%=path%>/resources/style/blue/images/bg.jpg) no-repeat;background-size:cover!important;" onload="init()">
   ...
   <div class="topbg">
	...
	<div class="top_right">
		<div id="taskbar_right">
			<div class="huanfu_con" style='display:nnone;'>
				<a class="pngFix dropdown-toggle" href="#" id="huanfu" style="background: #63c5ea"><i class="fa fa-black-tie"></i></a> 
		        <ul class="huanfu_warp">
					<li class="theme-bg">                        
		...
		<c:forEach items="${listxx}" var="map">
			<c:choose>
		   		<c:when test="${map.id eq '1'}">  <!-- 主页  -->
			   	 <a class="pngFix" href="javascript:getReturn()"; onmouseover="toShow('home');" onmouseout="toHidden('home')"  id="home" style="background: #ed8181;">
				 <i class="${map.icon}"></i></a> 
	              ...
	              <div class="top-inner">${map.ms} </div>
		   		...
		   		<a  class="pngFix" href="javascript:BOX_show('updMm');" onmouseover="toShow('unlock');" onmouseout="toHidden('unlock')"  id="unlock" style="background: #45B6B0;">
		 		<i class="${map.icon}"></i></a> 
	              ...
	              <div class="top-inner">${map.ms} </div>
		   		...
		   		<a   class="pngFix" href="javascript:logout();" onmouseover="toShow('power');" onmouseout="toHidden('power')"  id="power" style="background: #e8c566;">
		 		<i class="${map.icon}"></i></a> 
	          <div class="toptip"  id="power_a" style="display:none">
	              ...
	              <div class="top-inner">${map.ms} </div>
		   		...
		   		<a class="pngFix"  href="javascript:void(0);" onclick="javascript:createTab('uuu5555555','个人菜单维护','<%=path%>	/grb/queryGrbcd');"  onmouseover="toShow('grwh');" onmouseout="toHidden('grwh')"  id="grwh" style="background: #89aace;">
		 		<i class="${map.icon}"></i></a> 
	          <div class="toptip"  id="grwh_a" style="display:none">
	              ...
	              <div class="top-inner">${map.ms}</div>
		   		...
		   		<a  class="pngFix"  href="javascript:void(0);" onclick="javascript:zybjsz()" onmouseover="toShow('tooltitle');" onmouseout="toHidden('tooltitle')"  id="tooltitle" style="background: #FFA200;">
		 		<i class="${map.icon}"></i></a>
	          <div class="toptip"  id="tooltitle_a" style="display:none">
	              ...
	              <div class="top-inner">${map.ms} </div>
		   		...
		   		<c:when test="${map.id eq '6'}">  <!-- 角色 -->
				   	 	<div id="site-nav">
						<div class="switch">
							<div class="photo"><a class="pngFix" title="${map.ms}" href="javaScript:void(0);"  style="background: #63c5ea"><i class="${map.icon}"></i></a></div>
							<div class="switch-bd">
		   		...
		   		<a class="pngFix"  href="javascript:void(0);" onclick="javascript:top.closeAllTab();" onmouseover="toShow('th');" onmouseout="toHidden('th')"  id="th" style="background: #9973c2">
		 		<i class="${map.icon}"></i></a> 
