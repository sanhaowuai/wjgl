...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:rootUrl+"ueditor/image"             //图片上传提交地址
        ...
        //涂鸦图片配置区
        ,scrawlUrl:rootUrl+"ueditor/scraw"           //涂鸦上传地址
        ,scrawlPath:rootUrl                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:rootUrl+"ueditor/attach"               //附件上传提交地址
        ,filePath:rootUrl                   //附件修正地址，同imagePath
        ...
        , toolbars:[
            ['preview','undo', 'redo', '|',
                ...
                'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
                'directionalityltr', 'directionalityrtl', 'indent', '|','forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
                'touppercase', 'tolowercase','horizontal', 'spechars', '|',
                'link', 'unlink', 'anchor', '|','insertimage',  'imageleft', 'imageright', 'imagecenter', 
...
//        }
        ...
        ,initialStyle:'body{line-height:1.5em;}p{line-height:1.5em;}'//编辑器层级的基数,可以用来改变字体等
...
//           ]
        ...
        //,scaleEnabled:false
        ,minFrameWidth:980    //编辑器拖动时最小宽度,默认800
        ,minFrameHeight:360  //编辑器拖动时最小高度,默认220
