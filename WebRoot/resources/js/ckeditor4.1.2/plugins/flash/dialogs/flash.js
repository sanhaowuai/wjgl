...
(function(){
	...
	function c(a,b,c){
		...
		if(k)
			for(var f=""===this.getValue(),e=this instanceof CKEDITOR.ui.dialog.checkbox,d=0;d<k.length;d++){
				var h=k[d];
				switch(h.type){
					case g:if(!a||"data"==h.name&&b&&!a.hasAttribute("data"))continue;
					var l=this.getValue();
					...
					break;
					case i:if(!b)continue;l=this.getValue();
	...
	for(var g=1,o=2,i=4,
			n={
				...
				style:[{type:g,name:"style"},{type:i,name:"style"}],
				type:[{type:i,name:"type"}]
			},
			m="play loop menu quality scale salign wmode bgcolor base flashvars allowScriptAccess allowFullScreen".split(" "),j=0;j<m.length;j++)
		n[m[j]]=[
		         {type:i,name:m[j]},
		         {type:o,name:m[j]}
		];
	...
	CKEDITOR.dialog.add("flash",function(a){
		var g=!a.config.flashEmbedTagOnly,i=a.config.flashAddEmbedTag||a.config.flashEmbedTagOnly,k,f="<div>"+
			  CKEDITOR.tools.htmlEncode(a.lang.common.preview)+'<br><div id="cke_FlashPreviewLoader'+
			  CKEDITOR.tools.getNextNumber()+'" style="display:none"><div class="loading">&nbsp;</div></div><div id="cke_FlashPreviewBox'+
			  CKEDITOR.tools.getNextNumber()+'" class="FlashPreviewBox"></div></div>';
		return{
				  ...
				  onShow:function(){
					...
					onOk:function(){
						...
						if(this.fakeImage)e=this.objectNode,d=this.embedNode;
							...
							if(e)
								...
								e.setAttributes(f);e.setStyles(c);
					...
					onHide:function(){
						this.preview&&this.preview.setHtml("")},
							 contents:[{
								 		id:"info",
								 		label:a.lang.common.generalTab,accessKey:"I",
								 		elements:[{
								 					type:"vbox",
								 					padding:0,
								 					children:[{
								 								...
								 								children:[{
								 											id:"src",
								 											type:"text",
								 											label:a.lang.common.url,required:!0,
				 							...
				 							},
				 							{
				 								...
				 								label:a.lang.common.upload,elements:[{
				 								                                    	 type:"file",
				 								                                    	 id:"upload",
	                                    	...
	                                    	},
	                                    	{
	                                    		...
	                                    		elements:[{
                                    		        	  ...
                                    		        	  children:[{
                            		        		  		 ...
                            		        		  		 label:a.lang.flash.scale,"default":"",
                            		        		  		 style:"width : 100%;",
