	...
	var r=function(c,j){
			...
			if(!s){
				...
				if(d){
					...
					for(var a=[].concat(a),e=a.length,c,g=0;g<e;g++)
						(c=b.getContentElement.apply(b,a[g].split(":")))&&c.setup(f,d)}s=0
			}
		}
		...
		l=function(a,b){
			...
			if("check"==b){
				...
				return a.lockRatio},x=function(a){
				...
				p=n("btnLockSizes"),
				u=n("btnResetSize"),m=n("ImagePreviewLoader"),
				A=n("previewLink"),
				z=n("previewImage");
				return{
					...
					onShow:function(){
						...
						this.firstLoad=!0;this.addLink=!1;
					...
					onOk:function(){
						if(this.imageEditMode){
							...
							"image"==j&&"input"==a&&confirm(c.lang.image.button2Img)?(this.imageElement=c.document.createElement("img"),
																					  ...
																					  "image"!=j&&"img"==a&&confirm(c.lang.image.img2Button)?(this.imageElement=c.document.createElement("input"),
					    ...
					    elements:[{
						    ...
						    children:[{
							    ...
							    children:[{
								    id:"txtUrl",
								    type:"text",
								    label:c.lang.common.url,required:!0,
								    onChange:function(){
								   		...
								   		if(0<b.length){
								   			...
								   			var c=CKEDITOR.document.getById(m);c&&c.setStyle("display","");
								   			d.on("load",q,a);
								   			d.on("error",h,a);
								   			d.on("abort",h,a);
							   ...
							   },
							   {
									...
									label : '上传',
									onClick : function() {
										var retFile = showModalDialog(
												"/incon3.2/jsp/commons/demo/ckeditor/ckeditor_upload.jsp",
												"upimgwin",
												"dialogHeight:200px;dialogWidth:400px;center:1;");
										if (retFile != null) {
							   ...
							   },
							   {
								   ...
								   hidden:!0,filebrowser:"info:txtUrl"
							   }]
						   }]
					   },
					   {
						   ...
						   children:[{
							   ...
							   },
							   {
								   ...
								   },
								   {
									   ...
									   setup:function(a,b){
										   if(a==f){
											   var c,e;c=b.getStyle("margin-top");
...
"</td></tr></table></div></div>"
				    ...
				    },
				    {
				    	...
				    	elements:[{
				    		...
				    		children:[{
				    			type:"text",
				    			id:"linkId",requiredContent:"img[id]",
				    		...
				    		{
				    			id:"cmbLangDir",
				    			type:"select",requiredContent:"img[dir]",style:"width : 100px;",
				    		...
				    		{
				    			type:"text",id:"txtLangCode",requiredContent:"img[lang]",
				    			label:c.lang.common.langCode,"default":"",
				    			setup:function(a,b){
				    	...
				    	},
				    	{
				    		...
				    		children:[{
				    			type:"text",id:"txtGenClass",
				    			requiredContent:"img(cke-xyz)",
				    			label:c.lang.common.cssClass,"default":"",
				    			setup:function(a,b){
