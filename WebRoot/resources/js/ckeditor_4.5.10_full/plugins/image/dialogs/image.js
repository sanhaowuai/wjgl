                        ...
                        children: [{
                        ...
                        },
						   {
							...
							onClick : function() {
							    ...
							    var saHeight="400px";
							    var saWidth="400px";
								var URL="/incon3.2/jsp/commons/demo/ckeditor/ckeditor_upload.jsp?&anticache="+Math.floor(Math.random()*100000);
							    var obj="exam";
							    ...
							    if(ua.match(/chrome\/([\d.]+)/)){  
							    	...
							    	retFile = window.showModalDialog(URL,obj,'dialogWidth:'+saWidth+'px;dialogHeight:'+saHeight+'px;status:no');
									if (retFile != null) {
