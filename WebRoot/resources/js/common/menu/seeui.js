	...
	$(document).ready(function(){
		...
		//
		$("#leftmenu04>ul>li>a").click(function(e){
			e.stopPropagation();
		...
		//
		$("#leftmenu04 ul li> ol li").hover(function(){
		...
		//
		$("#leftmenu04>ul>li.widget>a").click(function(e){
			e.preventDefault();
			e.stopPropagation();
		...
		$("#leftmenu04 li>div.content, #pannelDash .menu ul li").click(function(e){
			e.preventDefault();
			e.stopPropagation();
		});
