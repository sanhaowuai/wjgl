var ZuJianHtmlCreate=function(t){
	...
	this.gridtable=function(){
		var _tableId=key
        var grid=$('<table rows="1" _DomOption={} cols="2" class="grid" id="table_'+_tableId+'" name="table_'+_tableId+'"  border="1" ></table>')
         var nodeObject_table=new Object()
    	     nodeObject_table.ID='table_'+_tableId
    	     nodeObject_table.WIDTH='auto'
    		 nodeObject_table.HEIGHT='auto'
	...
	this.dataform=function(){
		...
		return $('<div _DomOption={} id="'+key+'" load="" action="" method=""  dataform="true" name="'+keyName+'" class="dataform layoutTarget"  _width=300px _height=80px style="width:300px ;height:80px;   float:left;border:dashed 1px #000"></div>')
	}
	this.dcard=function(){
