(function(c) {
	...
	function b(f, e) {
		...
		e.prepend('<div class="plupload_wrapper plupload_scroll"><div id="'
				...
				+ '</div></div></div><div class="plupload_content"><div class="plupload_filelist_add"><div class="plupload_file_name"><div class="plupload_buttons"><a href="#" class="plupload_button plupload_add">'
				+ a("Add files")
				//+ '</a><a href="#" class="plupload_button plupload_start">'
			    //+ a("Start upload")
				+ '</a></div><span class="plupload_upload_status"></span></div></div><div class="plupload_filelist_header"><div class="plupload_file_name">'
				+ a("Filename")
						...
						function g() {
							...
							c.each( j.files,function(p, o) {
												...
												if (o.status == plupload.DONE) {
													if (o.target_name) {
														l += '<input type="hidden" name="hfjs" value="'
																+ plupload
													...
													l += '<input type="hidden" name="qfjs" value="'
															+ plupload
																	.xmlEncode(o.name)
															+ '" />';
