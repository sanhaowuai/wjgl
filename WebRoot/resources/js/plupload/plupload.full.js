						...
						function n() {
							...
							function y(D) {
								...
								if (w) {
									...
									c.each(c.extend(A,s.settings.multipart_params),
													function(	K,J) {
														C.append(F
																		+ I
																		+ H
							...
							c.each(s.settings.headers,function(D,
													C) {z.setRequestHeader(
																C,
																D)
											});
							z.upload.onprogress = function(
									C) {p.loaded = r + C.loaded	- v;
		...
		g .bind(  "UploadFile",
						function(n, k) {
							...
							function r(t, v) {
								...
								u = p.shift();
								e.Uploader.upload( {url : n.settings.url,
													files : {
														file : u
													},
