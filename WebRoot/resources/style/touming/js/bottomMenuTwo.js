...
function loadkjcd(){
	...
	var left_width=isHidden==0?250:50;
	$('#cdbutton').unbind()
...
// 		$('#e1').css('position','absolute')
		 ...
		 if($('#kjcdbar').attr('zt')=='open'){       
				$('#kjcdbar').css({ 
				 ...
				 $('#cdbutton').addClass("hidden_bottom hidden_bottom_b")  
	 		     $('#myiframes,#center').height(wHeight - 100 - 63-77);
				 $('#myiframes,#center').width(wWidth - left_width)
	 			 }else{
	 				$('#kjcdbar').css({ 
						   "height":""+kk+"px",
				     ...
				     $('#cdbutton').addClass("hidden_bottom hidden_bottom_t")
		 		     ...
		 		     $('#myiframes,#center').height(wHeight - 100-77);
					 $('#myiframes,#center').width(wWidth - left_width)
		...
		$('#qhcd').css('right','0px') 
			...
			var kk=0	
		     ...
		     $('#myiframes,#center').height(wHeight - 100-66);
	 	 		$('#kjcdbar').css({ 
	 		 ...
	 		 if($('#kjcdbar').attr('zt')=='open'){
	 			 $('#kjcdbar').show()
	 		      ...
	 		      $('#myiframes,#center').width(wWidth - left_width - 63);
	 			 }else{
	 		 		    $('#kjcdbar').hide() 
		 		        $('#cdbutton').removeClass()
